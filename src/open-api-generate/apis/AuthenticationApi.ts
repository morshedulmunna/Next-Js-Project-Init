...
import type { AuthResponse, LoginRequest, RefreshRequest, RegisterRequest, TokenResponse } from "../models/index";
import {
...
export class AuthenticationApi extends runtime.BaseAPI {
    ...
    async signUpRaw(
        ...
        if (requestParameters["registerRequest"] == null) {
            throw new runtime.RequiredError("registerRequest", 'Required parameter "registerRequest" was null or undefined when calling signUp().');
        }
